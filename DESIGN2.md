...
*conversion-cell* — A single row in the BTC ↔️ USD conversion table. Transparent background, text {colors.body-on-light}, type {typography.body-md}. Pair label on left (BTC, USDT, etc.); USD equivalent on right.
